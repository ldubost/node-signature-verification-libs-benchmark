...
/*    var message =  new Buffer(message, 'utf8')
    var signedMsg = Buffer.concat([
      new Buffer(this.sig, 'base64'),
      message
    ]);
    var publicKey = new Buffer(_pubkey, 'base64')
*/
    var r = tweetnacl.sign.detached.verify(string_to_Uint8Array(message), base64_to_Uint8Array(this.sig), base64_to_Uint8Array(_pubkey));
    assert(r, "Verification failed!");
  }
};

console.log(" - testing tweetnacl", ROUNDS, "rounds of", SIGNATURES, "signatures");
